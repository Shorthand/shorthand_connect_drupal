...
stories on a Drupal website. Create your Shorthand account at
https://app.shorthand.com/signup/ to get a User ID and API Token
(found on the account settings page) which are prerequisite for using this
 module.
